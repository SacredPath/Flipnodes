...
export default function AdminDashboardPage() {
  ...
  const quickActions = [
    { title: 'User Management', description: 'Manage users and permissions', icon: '👥', href: '/admin/users' },
    { title: 'System Settings', description: 'Configure system parameters', icon: '⚙️', href: '/admin/settings' },
    { title: 'Analytics', description: 'View detailed analytics', icon: '📊', href: '/admin/analytics' },
    { title: 'Support Tickets', description: 'Handle support requests', icon: '🎫', href: '/admin/support' }
  ]
