...
export default function AdminShipmentsPage() {
  const shipments = [
    ...
    },
    {
      ...
      progress: 25,
      value: '$32,500',
      customer: 'sarah.smith@logistics.com',
    ...
    },
    {
      ...
      progress: 100,
      value: '$28,750',
      customer: 'mike.johnson@import.com',
    ...
    },
    {
      ...
      progress: 0,
      value: '$52,300',
      customer: 'lisa.wang@electronics.com',
    ...
    },
    {
      ...
      progress: 45,
      value: '$38,900',
      customer: 'david.brown@machinery.com',
      createdAt: '2024-01-09'
    }
  ]

  const filters = [
    { label: 'All Shipments', value: 'all', count: 1247 },
    { label: 'In Transit', value: 'in_transit', count: 456 },
    { label: 'At Port', value: 'at_port', count: 123 },
    { label: 'Delivered', value: 'delivered', count: 568 },
    { label: 'Pending', value: 'pending', count: 100 }
  ]
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Admin Shipments</h1>
              <p className="text-gray-600 mt-1">Manage all shipments in the system</p>
            </div>
          ...
          <div className="px-6 py-4 border-b border-gray-200">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-4">
                <span className="text-sm text-gray-500">1,247 shipments</span>
                ...
                {shipments.map((shipment) => (
                  <tr key={shipment.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <div className="text-xs text-gray-500">Created: {shipment.createdAt}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex space-x-2">
                        <Button variant="outline" size="sm" href={`/admin/shipments/${shipment.id}`}>
                          View
                        </Button>
                        <Button variant="outline" size="sm">
                          Edit
